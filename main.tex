...
\begin{itemize}
    ...
    \item \textbf{Learned preconditioners}: GNN-based multigrid~\citep{luz2020learning} and meta-learned preconditioner selection~\citep{chen2022meta} could adaptively choose optimal preconditioners based on matrix structure, potentially improving convergence rates.
