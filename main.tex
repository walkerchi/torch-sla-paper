...
Table~\ref{tab:benchmark} compares solver backends across problem sizes spanning five orders of magnitude.
...
Table~\ref{tab:distributed} shows distributed CG on 4 NVIDIA H200 GPUs with NCCL backend.
