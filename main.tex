...
\begin{itemize}
    \item \textbf{GPU-accelerated sparse solvers}: We provide unified APIs for linear solves, nonlinear solves (Newton, Picard, Anderson acceleration), and eigenvalue computation (LOBPCG), with multiple backends (SciPy, cuDSS, PyTorch-native).
