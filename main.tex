...
\begin{itemize}
    ...
    \item \textbf{Sparse tensor parallelism} (\S\ref{sec:distributed}): We implement domain decomposition with automatic halo exchange, enabling multi-GPU scaling to \textbf{400 million DOF on 3 GPUs}.
