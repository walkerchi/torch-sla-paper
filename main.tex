...
\begin{itemize}
    ...
    \item \textbf{Adjoint-based differentiation} (\S\ref{sec:adjoint}): We implement the adjoint method for linear, nonlinear, and eigenvalue problems, achieving $\cO(1)$ graph nodes and $\cO(\text{nnz})$ memory---independent of solver iterations.
\end{itemize}
