...
We presented \torchsla{}, a differentiable sparse linear algebra library with two innovations: (1) adjoint-based differentiation achieving $\cO(\text{nnz})$ graph complexity, and (2) distributed sparse computing with halo exchange. The library scales to 169M DOF on single GPU.
